//Llamamos el localStore de usuario de login
document.addEventListener("DOMContentLoaded", function() {
    //llamamos el usuario que esta guardado en el localstore
    var Usuario = localStorage.getItem('Usuario');
    if (Usuario) {
        //creamos variables con una imagen de login y el nombre de usuario 
        ...
        //cambiamos la palabra registrar la cual dimos el nombre del id con PalabraRegistrar 
        document.getElementById('PalabraRegistrar').innerHTML = iconoUsuario + nombreUsuario;
    }
});


//Este modulo es para Cerrar sesion y no pueda volver 
//capturamos el evento cuando damos click
